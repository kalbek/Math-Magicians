    ...
    <div className="flex-column-start">
      <div className="content p-5">
        <div className="sub-title">
          <h3>An enchanting world of numbers designed just for kids!!</h3>
        </div>
        ...
        <div className="second-pareagraph">
          Math Magicians isn&apos;t just about solving equations; it&apos;s a place where
          young mindsdiscover the wonder in numbers. Our interactive games and educational
          resources make math not only fun but also an empowering tool for young learners.
